...
const FRONT_URL = `https://${Cypress.env('GITHUB_USER_TEST')}-st-frontend.herokuapp.com/.`
const FRONT_URL_PROD = `https://${Cypress.env('GITHUB_USER_TEST')}-st-frontend-prod.herokuapp.com/.`
